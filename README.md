...
- Wed, Jan 25 Lecture 2: Introduction.
    ...
    + Reading engagement exercise 1:
    	* In your own words, what is "big data?" (at most 1 paragraph)From each of three readings listed above, quote/paraphrase a sentence or two that describes big data.  Write your answer in the Moodle assignment called "Reading Engagement Exercise #1".
    	* Come to class with an answer to this question: In Chapter 1 of the Big Data book, authors Kenneth Cukier and Viktor Mayer-Schonberger talk about letting the data speak. After listening to the talk by Susan Etlinger, how do you think Etlinger would respond to this idea of "letting the data speak?"   
